...
def all_teachers_join
  ...
  -- SELECT teachers.name, depts.name FROM teachers LEFT JOIN depts ON depts.id = teachers.dept_id;
  SQL
end
...
def all_depts_join
  ...
  -- SELECT teachers.name, depts.name FROM teachers RIGHT JOIN depts ON teachers.dept_id = depts.id;
  SQL
end
